...
<body class="bg-white text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
            ...
            @if (Route::has('login'))
                <nav class="flex items-center justify-end gap-4">
                    ...
                    @else
                          <a
                            href="{{ route('login') }}"
                            class="inline-block px-5 py-1.5 text-green-600 text-[#16a34a] border-[#19140035] border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal"
                        >
                            LOGIN
                        </a> 
                        ...
                        @if (Route::has('register'))
                            <a
                                href="{{ route('register') }}"
                                class="inline-block px-5 py-1.5 text-green-600 text-[#16a34a] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                                REGISTER
                            </a>
                        @endif
                    @endauth
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                <div class="bg-[#0a2540] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto flex items-center justify-center overflow-hidden">
    
    <!-- Weather Image -->
    <img 
        src="{{ asset('images/weather.jpeg') }}"
        alt="Weather Image"
...
<div class="w-full bg-gray-50 py-16">
    <div class="max-w-6xl mx-auto px-6 lg:flex items-center gap-10">
        ...
        <div class="lg:w-1/2 mb-8 lg:mb-0">
            <img src="{{ asset('images/lopo.jpeg') }}" 
                 alt="Hali ya hewa" 
        ...
        <div class="lg:w-1/2">
            ...
            <p class="text-gray-600 mb-6">
                Mfumo wa Kilimo Smart unatoa huduma mbalimbali kwa ajili ya kuboresha maamuzi ya kilimo kwa kutumia teknolojia ya hali ya hewa.
            </p>

            <ul class="space-y-3 text-gray-700">
                <li>✅ Utabiri wa hali ya hewa kwa wakati halisi</li>
                <li>✅ Taarifa za joto, upepo na mvua</li>
                <li>✅ Ushauri wa kilimo kulingana na hali ya hewa</li>
                <li>✅ Mfumo rahisi kutumia kwa kila mkulima</li>
            </ul>
        </div>
